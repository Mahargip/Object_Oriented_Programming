...
public class LoginView extends javax.swing.JPanel {
    ...
    public LoginView(ContactApp app) {
        initComponents();
        this.app = app;
    }
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (!(namaAwal.isEmpty() || namaAkhir.isEmpty())) {
            try {
                if (app.getAccountManager().login(namaAwal, namaAkhir)) {
                    app.currentUser = app.getAccountManager().getIndexAccount(namaAwal, namaAkhir);
                    app.showHomeView();
                } else {
