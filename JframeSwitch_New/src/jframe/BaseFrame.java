...
public class BaseFrame extends javax.swing.JFrame {
    ...
    public BaseFrame(Main app, String current) {
        initComponents();
        this.app = app;
        this.title = current;
        for ( String historyApp : app.getHistory() ) {
            this.historyText.append(historyApp).append("\n");
            this.TextPrevious.setText(historyApp);
        }
        this.history.setText(this.historyText.toString());
        this.PresentText.setText(title);
    }
