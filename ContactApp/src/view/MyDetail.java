...
public class MyDetail extends javax.swing.JPanel {
    ...
    public MyDetail(ContactApp app) {
        ...
        if (userProfile != null) {
            nama.setText(userProfile.getMyName());
            number.setText(userProfile.getMyNumber());
            email.setText(userProfile.getMyEmail());
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (userProfile == null) {
            userProfile = new Profile(nama, number, email);
            app.getCurrentAccount().setProfile(userProfile);
            btnSave.setText("Update");
        } else {
            userProfile.setMyName(nama);
            userProfile.setMyNumber(number);
            userProfile.setMyEmail(email);
        }
